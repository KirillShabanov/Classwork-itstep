...
public class Groups {
    ...
    public static void printGroups() {
        ...
        for (Person person : persons) {
            if (person.getAge() > 65) groups.add(person.getGroup());
        }
        ...
        for (Group group : sorted) System.out.println(group.getName());
    }

    public static void printGroupsStream() {

        Comparator<Group> comparator = (a, b) ->
                Integer.compare
                        (a.getSize(), b.getSize());
    ...
    public static void maxCountPersonInGroup() {
