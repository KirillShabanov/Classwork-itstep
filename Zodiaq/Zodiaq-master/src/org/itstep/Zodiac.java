...
public class Zodiac {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        //System.out.printf("Month: %s, day: %s%n",calendar.get(Calendar.MONTH)+1,calendar.get(Calendar.DAY_OF_MONTH));
        ...
        ResourceBundle bundleRU = ResourceBundle.getBundle("org.itstep/data/Signs_ru_RU",localeRU);
        String signRU = bundleRU.getString(signs[sign]);
        ResourceBundle bundleEN = ResourceBundle.getBundle("org.itstep/data/Signs_en_US",localeEN);
        String signEN = bundleEN.getString(signs[sign]);
        System.out.println(signRU + ", " + signEN);
    }
}
class ZodiacSign{
    //private String name;
